...
FastfoodScene.prototype = {
  nextScene:'FastfoodTransition',
  musicName:'work_fastfood',
  background_good:{
    size: 1,
    fore: 1,
    0:{
      name:'fastfood_good_bg',
      sprite: null,
      position:{
        x: 0,y: 0
      },
  ...
  init: function () {
    ...
    // anchor 0
    this.status_box = game.make.sprite(0, 0 - this.status.distance, 'fastfood_status');
    this.sunny_icon = game.make.sprite(this.status.weather_icon.location.y, this.status.weather_icon.location.x - this.status.distance, 'fastfood_gloomy_icon');
    this.status_time_1015 = game.make.sprite(this.status.time.location.x, this.status.time.location.y - this.status.distance, 'fastfood_time_0910');
    this.status_time_1020 = game.make.sprite(this.status.time.location.x, this.status.time.location.y, 'fastfood_time_0930');
