...
DogSchoolScene.prototype = {
  ...
  startingTxtList:{
    ...
    1:[
        ['Joseph 我們到了！我們成功抵達終點了！','一路上經歷這麼多事情真是辛苦你了'],
        ['儘管碰上了許多困難','這一次的矇眼訓練你還是很成功喔！','只是……'],
        ['雖然你準備好了','這個世界卻還有許多危險的阻礙呢'],
        ['對不起','我們明天再繼續加油吧']
      ],
    2:[
        ['Joseph 我們到了！我們差一點就破紀錄了好可惜！','一路上經歷這麼多事情真是辛苦你了'],
        ['儘管有一些小失誤','這一次的矇眼訓練你還是大成功喔！','表示……'],
        ['你不再需要害怕','這個世界幾乎難不倒你了呀'],
        ['加把勁','我們明天還會更好的喔']
      ],
    3:[
        ['Joseph 我們到了！我們成功破了昨天的紀錄了！','一路上經歷這麼多事情真是辛苦你了'],
        ['儘管面對這麼多挑戰','這最後一次的矇眼訓練你完美達成了！'],
        ['所以……','驕傲地脫下披風吧','去成為引領盲人心之所向的英雄吧'],
