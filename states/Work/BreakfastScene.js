...
BreakfastScene.prototype = {
  ...
  init: function () {
    ...
    // anchor 0
    this.status_box = game.make.sprite(0, 0 - this.status.distance, 'breakfast_status');
    this.sunny_icon = game.make.sprite(this.status.weather_icon.location.y, this.status.weather_icon.location.x - this.status.distance, 'breakfast_gloomy_icon');
    this.status_time_1015 = game.make.sprite(this.status.time.location.x, this.status.time.location.y - this.status.distance, 'breakfast_time_0910');
    this.status_time_1020 = game.make.sprite(this.status.time.location.x, this.status.time.location.y, 'breakfast_time_0930');
