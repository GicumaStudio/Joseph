var BusTransition = function() {};

BusTransition.prototype = {
  nextScene: null,
  ...
  buttons:{
    ...
    1:{
      sprite:'breakfast_sprite',
      hover:'breakfast_hover',
      target_scene:'BreakfastScene',
      txt:'[ 早餐店 ]',
      x:615,
      y:590
    },
    2:{
      sprite:'fastfood_sprite',
      hover:'fastfood_hover',
      target_scene:'FastfoodScene',
      txt:'[ 速食店 ]',
      x:1305,
      y:590
    }
